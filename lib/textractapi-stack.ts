...
export class TextractApi extends Stack {
    constructor(scope: Construct, id: string, props: TextractApiProps) {
        ...
        api.root
            .addResource("analyze-document")
            .addMethod("POST", new apigw.LambdaIntegration(analyzeDocument), {
                apiKeyRequired: true,
                methodResponses: [
                    {
                        statusCode: "200",
        ...
        api.root
            .addResource("analyze-expense")
            .addMethod("POST", new apigw.LambdaIntegration(analyzeExpense), {
                apiKeyRequired: true,
                methodResponses: [
                    {
                        statusCode: "200",
        ...
        api.root
            .addResource("analyze-id")
            .addMethod("POST", new apigw.LambdaIntegration(analyzeId), {
                apiKeyRequired: true,
                methodResponses: [
                    {
                        statusCode: "200",
